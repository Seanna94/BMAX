...
<div id="fscada">
<img src="Images/空调机组.png" border="0" />
<div id="xianshi2" style="position:absolute;line-height:40px;left:1px;width:548px;height:40px;top:16px;font-family:'楷体','Serif';font-style:normal;font-size:28px;font-weight:normal;color:rgb(255,255,255);" >>>楼宇自控系统 >>> 空调机组</div>
<img id="imageex1" style="position:absolute;border:0px;left:0px;top:60px;width:1865px;height:946px;" src="images/组合式空调机组.jpg" />
