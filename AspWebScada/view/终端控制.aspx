...
<div id="fscada">
<img src="Images/终端控制.png" border="0" />
<div id="xianshi2" style="position:absolute;line-height:40px;left:1px;width:548px;height:40px;top:16px;font-family:'楷体','Serif';font-style:normal;font-size:28px;font-weight:normal;color:rgb(255,255,255);" >>>公共广播系统 >>> 终端控制</div>
<img id="imageex1" style="position:absolute;border:0px;left:8px;top:56px;width:1470px;height:946px;" src="images/背景音乐.jpg" />
