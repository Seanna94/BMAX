...
<%
	...
	var sql = "SELECT b.NAME, a.PHYSICAL_NO,date_format(a.IN_TIME,'%Y-%m-%d %H:%i:%s'),a.CARD_TYPE,a.ESTABLISH_NAME,a.SERVICESET_NAME,a.REMARK FROM jsds.t_park_record_in a left join jsds.t_base_person b on a.PHYSICAL_NO = b.CARD_CODE";
