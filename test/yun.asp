		...
		<div style="padding-left: 19px; margin-top: -10px;margin-left: -10px; background-color: #0A1F30;width: 100%;height: 50px;">
	 	...
	 	<div id="show_data" style="margin: 30px auto;">
	 		<table id="show_table" style="margin: 0 auto; " cellpadding="0" cellspacing="0">
		 		...
		 		<%
		 			var sql =  "select top(100) per.Base_PerID,per.Base_PerName,s.Base_CardNo,d.Cost_DevName,s.Cost_Money,s.Cost_Remain ,CONVERT(Varchar(100),s.Cost_DateTime,25),s.Base_Modify_User from General_Personnel per, Consume_Source s,Consume_Device d where per.Base_PerID = s.Base_PerID and d.Cost_DevID = s.Cost_DevID order by s.Cost_DateTime desc";
